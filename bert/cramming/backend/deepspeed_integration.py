...
def initialize_deepspeed(model, dataset, validation_set, tokenizer, cfg_train, cfg_impl, setup=_default_setup):
    ...
    return model_engine, optimizer, scheduler, dataloader, validation_dataloader
