...
def prepare_pretraining_dataloader(dataset, tokenizer, cfg_train, cfg_impl, is_validation: bool = False):
    ...
    if is_validation or cfg_impl.rho_loss:
        print("Using non-repeating dataloader for validation or rho loss.")
        return DataLoader(
            dataset,
