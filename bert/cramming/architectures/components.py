...
from .attention import FLASH, get_attention_mechanism
from .embeddings import LearnablePositional, ScaledSinosoidal, SinusoidalPositional
    ...
    def __init__(self, idx, cfg_arch):
        ...
        if self.norm_scheme == "sandwich":
            ...
            self.fn_training, self.fn_eval = get_layer_fn(
                ...
                drop=cfg_arch.layer_drop.enabled,
            )
